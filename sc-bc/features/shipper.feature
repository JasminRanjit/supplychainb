Feature: Tests related to Shippers
    ...
    Scenario: shipper1 invokes the ShipmentPickup transaction
        And I submit the following transaction of type org.am.network.ShipmentPickup
            | shipment |
            | SHIP_001 |
        Then I should have received the following event of type org.am.network.ShipmentPickupEvent
            | message                                  | shipment |
            | Shipment picked up for shipment SHIP_001 | SHIP_001 |

    Scenario: shipper1 invokes the ShipmentLoaded transaction
        And I submit the following transaction of type org.am.network.ShipmentLoaded
            | shipment |
            | SHIP_001 |
        Then I should have received the following event of type org.am.network.ShipmentLoadedEvent
            | message                               | shipment |
