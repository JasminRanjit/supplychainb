 ...
 * @param {org.am.network.ShipmentReceived} shipmentReceived - the ShipmentReceived transaction
 * @transaction
 */
function receiveShipment(shipmentReceived) {
    ...
    return getParticipantRegistry('org.am.network.Grower')
        .then(function (growerRegistry) {
            // update the grower's balance
            return growerRegistry.update(contract.grower);
        })
        .then(function () {
            return getParticipantRegistry('org.am.network.Importer');
        })
        ...
        .then(function () {
            return getAssetRegistry('org.am.network.Shipment');
        })
 ...
 * @param {org.am.network.TemperatureReading} temperatureReading - the TemperatureReading transaction
 * @transaction
 */
 ...
 * @param {org.am.network.GpsReading} gpsReading - the GpsReading transaction
 * @transaction
 */
